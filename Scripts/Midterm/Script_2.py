...
comp2_wins = []
ties = []
for i in range(100): #iterates 100 games
    ...
    if (comp1_choice == "R" and comp2_choice == "S") or (comp1_choice == "S" and comp2_choice == "P") or (comp1_choice == "P" and comp2_choice == "R"): #cases where computer 1 would win
        comp1_wins.append(1) #appends to computer 1 wins list
    elif (comp2_choice =="R" and comp1_choice == "S") or (comp2_choice == "S" and comp1_choice == "P") or (comp2_choice == "P" and comp1_choice == "R"): #cases where computer 2 wins
        comp2_wins.append(1)
    else:
        ties.append(1)
